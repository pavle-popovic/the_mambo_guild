...
Audit your internal monologue during practice. Every time you catch yourself thinking about a specific body part, immediately reframe the thought as an external cue. Build a personal translation dictionary:

- Your most common internal cues in the left column.
- Their external equivalents on the right.

Use only the external versions during drill repetitions. Every. Single. Time.
...
**1. What is the Constrained Action Hypothesis?**
A) Attention to external objects limits movement amplitude
B) An internal focus of attention invokes conscious cortical control, interfering with automatic subcortical motor execution
C) Dancers should constrain their range of motion during skill acquisition
D) Feedback should be constrained to once per set of repetitions
*Correct Answer: B) The CAH states that internal focus triggers cortical involvement in movements better managed by the cerebellum and basal ganglia, introducing noise and reducing performance quality. You're handing the wheel to the wrong driver.*

**2. Which neural systems are liberated when a dancer adopts an external focus of attention?**
A) Prefrontal cortex and anterior cingulate
B) Hippocampus and amygdala
C) Cerebellum and basal ganglia
D) Primary somatosensory cortex and thalamus
*Correct Answer: C) External focus removes cortical interference, allowing the cerebellum (timing, precision) and basal ganglia (automated sequencing) to execute movement programs at their optimal capacity. These are the systems you actually want in charge.*

**3. Which of the following is an example of correctly reframing an internal cue to an external cue?**
A) "Think about your left knee" → "Think about your right knee"
...
| Source | Notes |
|---|---|
| Wulf, G., Höß, M., & Prinz, W. (1998). Instructions for Motor Learning: Differential Effects of Internal Versus External Focus of Attention. *Journal of Motor Behavior*, 30(2), 169–179. | The original experimental paper establishing the external focus advantage using a ski-simulator paradigm; introduced the Constrained Action Hypothesis. |
| Wulf, G., & Lewthwaite, R. (2016). Optimizing Performance Through Intrinsic Motivation and Attention for Learning: The OPTIMAL Theory of Motor Learning. *Psychonomic Bulletin & Review*, 23(5), 1382–1414. | Extends attentional focus research into the OPTIMAL theory, integrating motivational variables with attentional focus in a unified motor learning framework. |
| Wulf, G. (2007). *Attention and Motor Skill Learning*. Human Kinetics. | Comprehensive book-length synthesis of 15+ years of attentional focus research, with practical cueing applications across multiple sport and dance domains. |
