...
But here's where it breaks down. Once you can reliably hit the correct counts, the basic outcome is consistently achievable. KR keeps giving you green lights. And you keep feeling like you're improving.
...
The KR dancer optimizes for green lights. The KP dancer optimizes for the quality of every single green light.

## What You're Going to Do About It

Stop asking yourself binary outcome questions during practice.

Replace "Did I hit the beat?" with "What was my weight doing at beat one?" Replace "Did I get the turn?" with "Where did my collected foot land relative to where I intended?"

Identify the **three most relevant kinematic variables** for your current weakest technique. For basic steps, consider: (1) weight transfer arrival timing relative to the beat, (2) foot contact sequence, (3) hip placement. Focus exclusively on these process variables for four weeks. Use slow-motion video (Module 8) to observe them directly. Track improvement in these kinematic dimensions, not in general "feel."
...
**1. According to Schmidt's (1975) schema theory, what does Knowledge of Results (KR) primarily update?**
A) The recognition schema that stores expected sensory consequences of movement
B) The recall schema that stores motor command parameters, allowing adjustment of command magnitude
C) The kinematic profile stored in the supplementary motor area
D) Proprioceptive calibration in the muscle spindles
*Correct Answer: B) KR informs the motor system whether its output command produced the intended outcome, allowing the recall schema to adjust command parameters for the next attempt. It does not address the quality of the movement process itself.*

**2. Why does KR become insufficient as a primary feedback mechanism for advanced dancers?**
A) Advanced dancers process KR too quickly to benefit from it
...
| Source | Notes |
|---|---|
| Schmidt, R.A. (1975). A Schema Theory of Discrete Motor Skill Learning. *Psychological Review*, 82(4), 225–260. | Foundational schema theory paper distinguishing recall and recognition schemas; establishes the theoretical basis for KR and KP as distinct information types with different learning functions. |
| Salmoni, A.W., Schmidt, R.A., & Walter, C.B. (1984). Knowledge of Results and Motor Learning: A Review and Critical Appraisal. *Psychological Bulletin*, 95(3), 355–386. | Comprehensive review establishing the hierarchical relationship between KR and KP, with evidence that KP becomes the dominant factor for advanced performers on complex tasks. |
| Newell, K.M., & Walter, C.B. (1981). Kinematic and Kinetic Parameters as Information Feedback in Motor Skill Acquisition. *Journal of Human Movement Studies*, 7, 235–254. | Experimental evidence directly comparing KP and KR feedback in trained performers; demonstrates KP superiority for kinematic consistency and precision in skilled movement. |
