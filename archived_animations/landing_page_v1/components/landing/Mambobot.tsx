...
const MessageBubble = ({ message }: { message: Message }) => {
  ...
  // Type guard for recommendation result
  ...
  // Type guard for knowledge base result
  ...
  return (
    <div
      className={`mambobot-message ${isUser ? "mambobot-message-user" : ""}`}
    >
      <div
        className={`mambobot-avatar ${isUser ? "mambobot-avatar-user" : ""}`}
      >
        {isUser ? "U" : "D"}
      </div>
      <div className="flex flex-col gap-2 max-w-[85%]">
        ...
        {message.content && (
          <div
            className={`mambobot-bubble ${isUser ? "mambobot-bubble-user" : ""}`}
          >
            {message.content}
          </div>
        )}
        ...
        {hasKnowledgeBase && knowledgeBaseData && (
          <div className="mambobot-bubble mambobot-knowledge-bubble">
            <div className="text-[10px] text-amber-500/70 uppercase tracking-wider mb-1 font-semibold">
              Knowledge Base
            </div>
            {knowledgeBaseData.result}
          </div>
        )}
      </div>
    </div>
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .mambobot-knowledge-bubble {
          background: linear-gradient(145deg, rgba(100, 80, 50, 0.3) 0%, rgba(60, 40, 20, 0.4) 100%);
        ...
        <div className="mambobot-base">
          {isOpen ? (
            ...
            >
              ...
              <div className="mambobot-chat-header">
                <div className="mambobot-chat-header-content">
                  <h3 className="mambobot-chat-title">DIEGO</h3>
                  <span className="mambobot-chat-subtitle">Head Concierge</span>
                </div>
                <div className="mambobot-header-actions">
                  <motion.button
                    onClick={clearHistory}
                    className="mambobot-reset-btn"
                  ...
                  if (message.role === "model" && !message.content && !message.functionCall) {
                    return (
                      <div key={message.id} className="mambobot-message">
                        <div className="mambobot-avatar">D</div>
            ...
            <motion.button
              ...
              aria-label="Open chat with Diego"
            >
              {/* Filigree corners */}
              ...
              <div className="mambobot-screen">
                <h3 className="mambobot-title">DIEGO</h3>
                <p className="mambobot-subtitle">Head Concierge</p>
              </div>
