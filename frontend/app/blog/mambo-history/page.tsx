...
import { getMamboHistoryContent } from "./_content";
import MamboHistoryBody from "./_Body";
...
const content = getMamboHistoryContent("en");
...
export default function MamboHistoryPage() {
    return <MamboHistoryBody content={content} locale="en" />;
}
