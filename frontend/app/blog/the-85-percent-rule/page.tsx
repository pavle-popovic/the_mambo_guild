...
import { getEightyFiveContent } from "./_content";
import EightyFiveBody from "./_Body";
...
const content = getEightyFiveContent("en");
...
export default function EightyFivePercentRulePage() {
    return <EightyFiveBody content={content} locale="en" />;
}
