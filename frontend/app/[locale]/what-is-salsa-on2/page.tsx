...
import { getWhatIsOn2Content } from "../../what-is-salsa-on2/_content";
import WhatIsOn2Body from "../../what-is-salsa-on2/_Body";
...
export async function generateMetadata({
    ...
    const content = getWhatIsOn2Content(locale);
...
export default async function LocalizedWhatIsOn2Page({
    params,
}: {
    params: Promise<Params>;
}) {
    ...
    const content = getWhatIsOn2Content(locale);
    return <WhatIsOn2Body content={content} locale={locale} />;
}
