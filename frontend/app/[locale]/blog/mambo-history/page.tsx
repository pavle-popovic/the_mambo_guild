...
import { getMamboHistoryContent } from "../../../blog/mambo-history/_content";
import MamboHistoryBody from "../../../blog/mambo-history/_Body";
...
export async function generateMetadata({
    ...
    const content = getMamboHistoryContent(locale);
...
export default async function LocalizedMamboHistoryPage({
    params,
}: {
    params: Promise<Params>;
}) {
    ...
    const content = getMamboHistoryContent(locale);
    return <MamboHistoryBody content={content} locale={locale} />;
}
