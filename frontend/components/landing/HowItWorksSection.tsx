              ...
              <div className="mt-8 flex items-center justify-center landscape-phone:mt-5">
                {isSubscribed ? (
                  <div className="flex flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                    ...
                    <Link
                      href="/community"
                      className="flex-1 sm:flex-initial bg-[linear-gradient(135deg,rgba(59,130,246,0.25)_0%,rgba(168,85,247,0.25)_100%)] backdrop-blur-md border border-blue-400/40 hover:bg-[linear-gradient(135deg,rgba(59,130,246,0.4)_0%,rgba(168,85,247,0.4)_100%)] hover:border-purple-400/60 text-blue-100 font-extrabold py-3.5 px-4 sm:px-7 rounded-full text-sm sm:text-base tracking-wide shadow-[0_0_20px_rgba(168,85,247,0.3),inset_0_1px_0_rgba(255,255,255,0.2)] ring-1 ring-blue-400/30 active:scale-[0.97] transition-all landscape-phone:py-2.5 landscape-phone:text-sm text-center whitespace-nowrap"
                    >
