...
export default function NewHero() {
    ...
    return (
        <section className="relative min-h-[calc(100vh-56px)] sm:min-h-screen w-full flex items-start lg:items-center justify-center overflow-hidden bg-transparent pt-20 sm:pt-24 md:pt-24 landscape-phone:!pt-16">
            {/* Content Container */}
            <div className="hero-content-container relative z-10 container mx-auto max-w-7xl px-4 sm:px-6 md:px-12 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-3 md:gap-10 lg:gap-12 landscape-phone:!flex-row landscape-phone:!items-center landscape-phone:!gap-4 landscape-phone:!px-4">
                ...
                <motion.div
                    ...
                    className="flex-[1.5] w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl order-2 lg:order-2 landscape-phone:!order-2 landscape-phone:!flex-[1.1] landscape-phone:!max-w-[50%]"
                >
                ...
                >
                    ...
                    {/* Main Title. Mobile: big, allowed to wrap to 2 lines for long translations.
                        ...
                        long locales (Greek/Polish/German) may wrap to 2 rows, which is fine. */}
                    <div className="space-y-2 md:space-y-2.5 landscape-phone:!space-y-1 min-w-0">
                        <h1 className="leading-[1.05] tracking-tight text-mambo-gold drop-shadow-[0_0_30px_rgba(212,175,55,0.35)]">
                            <span className="block font-extrabold text-[clamp(1.5rem,5.5vw,2.5rem)] lg:text-[clamp(1.25rem,1.7vw,1.5rem)] xl:text-[clamp(1.4rem,1.9vw,1.85rem)] landscape-phone:!text-[clamp(1.1rem,3.2vw,1.6rem)]">
                                {t("title")}
                            </span>
                        </h1>
                    ...
                    >
                        {bulletPoints.map((point, index) => (
                            <motion.li
                                ...
                                className="flex items-center gap-2 sm:gap-3 text-base sm:text-lg md:text-xl text-gray-200 justify-center lg:justify-start landscape-phone:!text-[11px] landscape-phone:!gap-1.5 landscape-phone:!justify-start"
                            >
