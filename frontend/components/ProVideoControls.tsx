      ...
      <div className="space-y-3">
        ...
        {onToggleAB && (
          <div className="pt-3 border-t border-white/5">
            <button
              onClick={onToggleAB}
              className={`w-full flex items-center justify-center gap-2 px-3 py-3 rounded-lg font-black text-xs uppercase tracking-wide whitespace-nowrap transition-all ${
                abEnabled
                  ? "bg-black text-mambo-gold border-2 border-mambo-gold shadow-[0_0_25px_rgba(212,175,55,0.9)] hover:bg-zinc-900 animate-pulse-glow-gold"
