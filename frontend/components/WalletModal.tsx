              ...
              <>
                ...
                <div className="mb-2 grid grid-cols-2 gap-2">
                  <Link
                    href="/shop"
                    onClick={onClose}
                    className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 hover:from-amber-500/30 hover:to-orange-500/30 hover:border-amber-500/60 transition-all text-amber-100 font-semibold text-sm"
                  >
                    <ShoppingBag size={16} />
                    <span className="truncate">{tShop("pageTitle")}</span>
                  </Link>
                  <Link
                    href="/shop/inventory"
                    onClick={onClose}
                    className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-white font-semibold text-sm"
                  >
                    <Package size={16} />
