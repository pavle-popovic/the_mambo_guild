...
const WorldCard: React.FC<WorldCardProps> = ({ world }) => {
    return (
        <HoverCard className="h-full">
            <div className="bg-mambo-panel border border-white/10 hover:border-mambo-gold/50 hover:shadow-2xl hover:shadow-mambo-gold/10 transform hover:scale-[1.02] rounded-xl overflow-hidden transition-all duration-300 group cursor-pointer h-full flex flex-col shadow-lg shadow-black/20 z-0 hover:z-10">
