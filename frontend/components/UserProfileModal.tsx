                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    {profile.instagram_url && (
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg border border-pink-400/30 bg-gradient-to-r from-pink-500/15 via-fuchsia-500/15 to-amber-500/15 px-3 py-2 text-sm font-semibold text-pink-200 transition hover:from-pink-500/25 hover:via-fuchsia-500/25 hover:to-amber-500/25"
                      >
